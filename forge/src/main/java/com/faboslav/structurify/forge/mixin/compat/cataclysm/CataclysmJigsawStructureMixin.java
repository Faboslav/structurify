...
@Pseudo
@Mixin(value = CataclysmJigsawStructure.class)
public abstract class CataclysmJigsawStructureMixin extends StructureMixin implements StructurifyJigsawStructure
{
	...
	@Override
	public void structurify$setStructureResourceLocation(ResourceLocation structureSetResourceLocation) {
		super.structurify$setStructureResourceLocation(structureSetResourceLocation);
